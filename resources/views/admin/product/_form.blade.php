<fieldset>
    ...
    <div class="form-row">
        ...
        <div class="col-sm-12 col-md-3 col-lg-3">
            ...
            <input type="text" name="codInterno" id="codInterno" class="form-control" value="{{ isset($registro->codInterno) ? $registro->codInterno : '' }}" required>
        </div>
        <div class="col-sm-12 col-md-2 col-lg-2">
            <label for="valor">Valor</label>
            <input type="number" name="valor" id="valor" class="form-control valor" value="{{ isset($registro->valor) ? $registro->valor : '' }}" step="0.01" required>
        </div>
        <div class="col-sm-12 col-md-2 col-lg-2">
...
<fieldset>
    ...
    <div class="form-row">
        <div class="col-sm-12 col-md-12 col-lg-12">
            ...
            <input type="file" class="form-control" name="imagem" id="imagem" value="{{ isset($registro->imagem) ? $registro->imagem : '' }}">
        </div>
        <div class="col-sm-12 col-md-12 col-lg-12">
